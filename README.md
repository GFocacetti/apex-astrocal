...
> ⚠️ Build alpha: usale consapevole che potrebbero contenere bug.

I file pronti all'uso (installer + versione portable) si trovano nella pagina [Releases](https://github.com/GFocacetti/apex-astrocal/releases) — nessuna compilazione richiesta.
